...
# AstroDis
#f_in      = '%s/Gaussian_maps_kpivot=0.3_discon_0.3variation.npy'%root 
#f_out     = '%s/A_values_kpivot=0.3_discon_0.3variation.npy'%root
#wd        = 4e-4
#f_model   = '%s/models/%s_%d_wd=%.1e_kpivot=0.3_discon_0.3variation.pt'%(root_out, model, hidden, wd)
#f_results = '%s/results/%s_%d_wd=%.1e_kpivot=0.3_discon_0.3variation_A=1.00.txt'%(root_out, model, hidden, wd)
...
f_results = '%s/results/%s_%d_wd=%.1e_kpivot=0.3_A=1.00.txt'%(root_out, model, hidden, wd)
######################################################################################
...
# get the data
test_loader = data.create_dataset_maps(mode, seed, f_in, f_out, batch_size, 
                                       verbose=True)
